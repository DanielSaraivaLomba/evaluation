...
export default {
  data () {
    return {
      ...
      titles: [
        {title: '1 - Manuais originais e textos de apoio ao ensino originais, se editados pela escola ou entidade de reconhecido prestígio', key: 'ans1' },
        {title: '2 - Software didático original, se editado pela Escola ou entidade de reconhecido prestígio', key: 'ans2'},
        {title: '3 - Formações para atualização pedagógica ou profissional relevante para as atividades do docente', key: 'ans3'},
        {title: '4 - Participação em conferências (externas) com ou sem comunicação'},
